...
def upgrade() -> None:
    ...
    sa.Column('id', services.knowledge.models.UUID(), nullable=False),
    ...
    sa.Column('id', services.knowledge.models.UUID(), nullable=False),
    sa.Column('content_id', services.knowledge.models.UUID(), nullable=False),
    ...
    sa.Column('content_id', services.knowledge.models.UUID(), nullable=False),
    sa.Column('tag_id', services.knowledge.models.UUID(), nullable=False),
    sa.ForeignKeyConstraint(['content_id'], ['content_items.id'], ),
